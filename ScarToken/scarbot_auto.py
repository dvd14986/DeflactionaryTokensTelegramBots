#scarbot V1.3.2 - released 31 jul 2019
...
contractAddress="0xe5d3cbee3c4dacf69f7b35e0d1c5170fc92f3843"
coinName="SCAR"
max_supply=200
token='' #@ScarTokenBot
...
#config
ddex=1
forkdelta=1 #https://api.forkdelta.com/returnTicker
usedb=1
uselink=1
...
if (ddex==1):
    # #Get DDEX data
    print ("Get DDEX data")
    r=requests.get("https://api.ddex.io/v3/markets/" + coinName + "-WETH/ticker")
...
if (uselink==1):
    ...
    #link='Trade '+ coinName +' on <a href="https://forkdelta.app/#!/trade/'+contractAddress+'-ETH">ForkDelta</a>!\n'
...
customMex="Check out our new website <a href='https://scartoken.co/'>scartoken.co</a>!\n\nAND REMEMBER EVERYONE! We're looking out for keen and friendly SCARtians to help take over the project once it's up and running well!"
mex=burnMex_24h + "\n" + td + hmex + hlist  + lp + pd1 + pd2 + link + customMex
